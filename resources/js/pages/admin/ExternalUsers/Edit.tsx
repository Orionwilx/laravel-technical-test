...
interface ExternalUsersEditProps extends PageProps {
    user: User;
}

export default function ExternalUsersEdit({ user }: ExternalUsersEditProps) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/admin/external-users/${user.id}`);
    };
